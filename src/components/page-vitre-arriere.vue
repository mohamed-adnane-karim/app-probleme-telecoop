<template id="page-type">
    <body>
        <header class="wrapper-titre">
                <h1>
                    <span>{{ titresPages.titrePageVitre }}</span>
                </h1>
        </header>

        <header class="wrapper-sous-titre">
                <p class="p1">
                    <span>TeleCoop vous accompagne pour conserver votre mobile le plus longtemps possible.</span> <span>{{ titresPages.soustitrePageVitre }}</span>
                </p>
        </header>
                ...
                <div v-if="uiParams.isSection1Open" class="section-content">
                    ...
                    <div class="module_default-info" id="info-repa">
                        <header class="header-info">
                            ...
                            <span>{{ titresPages.souslabelPageVitreArrière }}</span>
                        </header>
                                ...
                                <div v-if="uiParams.selectedModele==='autre'">
                                    ...
                                    <div id="prix-composant">
                                        ...
                                        <div class="module_default-results">
                                            ...
                                            <span class="p2">
                                                <span>En moyenne, comptez </span><span style="font-weight: bold">{{ price_component }} €</span><span> pour racheter un nouveau composant pour votre téléphone.</span>
                                            </span>
                                ...
                                <div v-else>
                                    ...
                                    <div id="prix-composant">
                                        ...
                                        <div class="module_default-results">
                                            ...
                                            <div v-if="price_component!==-1">
                                                <span class="p2">
                                                    <span>En moyenne, comptez </span><span style="font-weight: bold">{{ price_component }} €</span><span> pour racheter un nouveau composant pour votre </span><span>{{ uiParams.selectedModele }}.</span>
                                                </span>
                                            </div>
                                            ...
                                            <div v-else>
                                                <span class="p2">
                                                    <span>Malheureusement nous n'avons pas le prix moyen d'un composant pour votre </span><span>{{ uiParams.selectedModele }}</span><span>. Nous faisons tout pour remédier à cela au plus vite!</span>
                                                </span>
                                            </div>   
                                    ...
                                    <div id="tuto">
                                        ...
                                        <div class="module_default-results">
                                            ...
                                            <div v-else>
                                                <span class="p2">
                                                    <span>Vous pouvez consulter le tutoriel pour changer les composants de votre </span><span>{{ uiParams.selectedModele }} </span> <span></span>
                                    ...
                                    <div id="outils">
                                        ...
                                        <div class="module_default-results-1">
                                            ...
                                            <div v-if="liste_outils==-1" style="text-align:justify">
                                                <span class="p2">Malheureusement le site de notre partenaire iFixit ne recense pas à ce jour la liste du matériel nécessaire pour changer certains composants de votre {{ uiParams.selectedModele }}. Nous faisons tout pour remédier à cela au plus vite!</span>
                                            </div>

                                            <!-- Pas besoin d'outils -->
                                            <div v-if="liste_outils==0" style="text-align:justify">
                                                <span class="p2">
                                                    <span style="font-weight:bold">Bonne nouvelle !</span><span>Aucun matériel n'est nécessaire pour changer le composant de votre {{ uiParams.selectedModele }}. On s'y met maintenant ?</span>
                                                </span>
                                            </div>
                                            ...
                                            <div v-if="liste_outils!==0&&liste_outils!==-1">
                                                <div class="p2" style="text-align: center">
                                                    <span>Afin de vous lancer dans la réparation de votre composant, vous aurez besoin de :</span>
                                                    <br>                                                    
                                                </div>
                                ...
                                <div v-else>
                                    ...
                                    <div id="tuto">
                                        ...
                                        <div class="module_default-results">
                                            ...
                                            <div v-if="link_tuto===0">
                                                <span class="p2">
                                                    <span>A ce jour, il n'y malheureusement aucun tutoriel sur le site de notre partenaire iFixit pour vous aider à changer vous même certains composants de votre </span><span>{{ uiParams.selectedModele }}.</span><span> Nous faisons tout pour remédier à cela au plus vite ! En attendant, n'hésitez pas à consulter les informations fournies sur le site de </span><span>{{ uiParams.selectedMarque }}.</span><span> Vous pouvez aussi passer par un réparateur agréé si vous ne souhaitez prendre aucun risque.</span>
                                                </span>
                                            </div>
                                            ...
                                            <div v-else>
                                                <span class="p2">
                                                    <span>Vous pouvez consulter le tutoriel pour changer le composant de votre </span><span>{{ uiParams.selectedModele }} </span> <span></span>
                                                    <a :href="link_tuto" target="_blank">en cliquant ici</a>
                                                    <span>.</span>
                                                </span>
                                            </div>
                                ...
                                <div v-if="uiParams.selectedModele==='autre'" class="module-1">
                                    ...
                                    <div id="prix-repa">
                                        ...
                                        <div class="module_default-results" >
                                            ...
                                            <div v-if="price_MO==-1||price_component==-1">
                                                <span class="p2">
                                                        <span>Malheureusement nous ne pouvons vous fournir le prix moyen d'une réparation d'un composant pour votre téléphone. Nous faisons tout pour remédier à cela au plus vite!</span>
                                                </span>
                                            </div>
                                            ...
                                            <div v-else>
                                                <span class="p2">
                                                    <span>En moyenne, comptez </span><span style="font-weight: bold">{{ price_repa }} €</span><span> pour faire réparer un composant de votre téléphone par un professionnel agréé.</span>
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div id="prix-composant">
                                        ...
                                        <div class="module_default-results">
                                            ...
                                            <div v-else>
                                                <span class="p2">
                                                    <span>Malheureusement nous n'avons pas le prix moyen d'un composant pour votre téléphone. Nous faisons tout pour remédier à cela au plus vite!</span>
                                                </span>
                                            </div>   
                                        </div>
                                    </div>
                                    ...
                                    <div id="prix-mo">
                                        ...
                                        <div class="module_default-results">
                                            ...
                                            <div v-if="price_MO!==-1">
                                                <span class="p2">
                                                    <span>En moyenne, comptez </span><span style="font-weight: bold">{{ price_MO }} €</span><span> de frais de main d'oeuvre chez un réparateur agréé pour réparer un composant de votre téléphone.</span>
                                                </span>
                                            </div>
                                            ...
                                            <div v-else>
                                                <span class="p2">
                                                    <span>Malheureusement nous n'avons pas le prix moyen de main d'oeuvre nécessaire pour réparer le composant de votre téléphone. Nous faisons tout pour remédier à cela au plus vite!</span>
                                                </span>
                                            </div>   
                                        </div>
                                    ...
                                    <div class="module-1">
                                        ...
                                        <div id="prix-repa">
                                            ...
                                            <div class="module_default-results" >
                                                ...
                                                <div v-if="price_MO==-1||price_component==-1">
                                                    <span class="p2">
                                                            <span>Malheureusement nous ne pouvons vous fournir le prix moyen d'une réparation de votre composant pour votre </span><span>{{ uiParams.selectedModele }}</span><span>. Nous faisons tout pour remédier à cela au plus vite!</span>
                                                    </span>
                                                </div>
                                                ...
                                                <div v-else>
                                                    <span class="p2">
                                                            <span>En moyenne, comptez </span><span style="font-weight: bold">{{ price_repa }} €</span><span> pour faire réparer le composant de votre </span><span>{{ uiParams.selectedModele }} par un professionnel agréé.</span>
                                                        </span>
                                                </div>
                                            </div>
                                        ...
                                        <div id="prix-mo">
                                            ...
                                            <div class="module_default-results">
                                                ...
                                                <div v-if="price_MO!==-1">
                                                    <span class="p2">
                                                        <span>En moyenne, comptez </span><span style="font-weight: bold">{{ price_MO }} €</span><span> de frais de main d'oeuvre chez un réparateur agréé pour réparer le composant de votre </span><span>{{ uiParams.selectedModele }}.</span>
                                                    </span>
                                                </div>
                                                ...
                                                <div v-else>
                                                    <span class="p2">
                                                        <span>Malheureusement nous n'avons pas le prix moyen de main d'oeuvre nécessaire pour réparer le composant de votre </span><span>{{ uiParams.selectedModele }}</span><span>. Nous faisons tout pour remédier à cela au plus vite!</span>
                                                    </span>
                                                </div>   
                                            </div>
                                ...
                                <div v-if="uiParams.selectedModele==='autre'" class="module-1">
                                    ...
                                    <div id="prix-repa">
                                        ...
                                        <div class="module_default-results" >
                                            ...
                                            <div v-else>
                                                <span class="p2">
                                                    <span>En moyenne, comptez </span><span style="font-weight: bold">{{ price_repa }} €</span><span> pour faire réparer le composant de votre téléphone par un professionnel agréé.</span>
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="module-1">
                                        ...
                                        <div id="prix-repa">
                                            ...
                                            <div class="module_default-results" >
                                                ...
                                                <div v-if="price_MO==-1||price_component==-1">
                                                    <span class="p2">
                                                            <span>Malheureusement nous ne pouvons vous fournir le prix moyen d'une réparation d'un composant pour votre </span><span>{{ uiParams.selectedModele }}</span><span>. Nous faisons tout pour remédier à cela au plus vite!</span>
                                                    </span>
                                                </div>
                                        ...
                                        <div id="prix-mo">
                                            ...
                                            <div class="module_default-results">
                                                ...
                                                <div v-if="price_MO!==-1">
                                                    <span class="p2">
                                                        <span>En moyenne, comptez </span><span style="font-weight: bold">{{ price_MO }} €</span><span> de frais de main d'oeuvre chez un réparateur agréé pour réparer un composant de votre </span><span>{{ uiParams.selectedModele }}.</span>
                                                    </span>
                                                </div>
                                                ...
                                                <div v-else>
                                                    <span class="p2">
                                                        <span>Malheureusement nous n'avons pas le prix moyen de main d'oeuvre nécessaire pour réparer un composant de votre </span><span>{{ uiParams.selectedModele }}</span><span>. Nous faisons tout pour remédier à cela au plus vite!</span>
                                                    </span>
                                                </div>   
                                            </div>
        ...
        <footer class="footer">
            ...
            <div v-for="(item, index) in Object.values(bonnes_pratiques_vitre_arriere)" :key="index" class="bullet-item">
...
<script setup>
    ...
    import { titresPages, bonnes_pratiques_vitre_arriere,annees } from '@/config/uiParams.js';
    ...
    const price_component = computed(()=>{
        if (uiParams.selectedModele!==""&&uiParams.selectedMarque!=""){
            const p = getPriceComponentForModel(uiParams.selectedModele,uiParams.selectedMarque,'divers');
            const price = p[0];
            return price;
        } else {
            return null
    ...
    const price_MO = computed (()=>{
        if (uiParams.selectedModele!==""&&uiParams.selectedMarque!=""){
            const p = getPriceMOForModel(uiParams.selectedModele,uiParams.selectedMarque,'divers');
            const price = p[0];
            return price;
        } else {
            return null
    ...
    const price_repa = computed (()=>{
        if (uiParams.selectedModele!==""&&uiParams.selectedMarque!=""){
            const price = getPriceRepa(uiParams.selectedModele,uiParams.selectedMarque,'divers');
            return price;
        } else {
            return null
        }
    ...
    const link_tuto = computed(()=>{
        if (uiParams.selectedModele!==""&&uiParams.selectedMarque!=""){
            const t = getLinkTuto(uiParams.selectedModele,'divers');
            const tuto = t[0];
            return tuto;
        } else {
            return null
    ...
    const liste_outils = computed(()=>{
        if (uiParams.selectedModele!==""&&uiParams.selectedMarque!=""){
            const l = getListOutils(uiParams.selectedModele,'divers');
            const liste = l[0];
            return liste;
        } else {
            return null
    ...
    const reduc_telecoop = computed(()=>{
        if (uiParams.selectedModele!==""&&uiParams.selectedMarque!=""){
            const reduc = getReducTeleCoop(uiParams.selectedModele,uiParams.selectedMarque,'divers');
            return reduc;
        } else {
            return null
        }
    ...
    const reduc_etat = computed(()=>{
        if (uiParams.selectedModele!==""&&uiParams.selectedMarque!=""){
            const reduc = getReducEtat(uiParams.selectedModele,uiParams.selectedMarque,'divers');
            return reduc;
        } else {
            return null
        }
