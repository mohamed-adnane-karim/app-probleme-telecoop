<template id="page-type">
    <body>
        <header class="wrapper-titre">
                <h1>
                    <span>{{ titresPages.titrePageAutre }}</span>
                </h1>
        </header>

        <header class="wrapper-sous-titre">
                <p class="p1">
                    <span>TeleCoop vous accompagne pour conserver votre mobile le plus longtemps possible.</span> <span>{{ titresPages.soustitrePageAutre }}</span>
                </p>
        </header>
...
<script setup>
    ...
    import { openRepairerLink,toggleSection, showSuggestions, selectCP } from '@/controller/controller';
