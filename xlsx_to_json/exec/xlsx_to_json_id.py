...
for _,row in database.iterrows():
    ...
    if telephone_id not in database_dict[0]:
        database_dict[0][telephone_id]=telephone_infos
        
# Écrire les données dans un fichier JSON
json_link=r'C:\Users\moham\OneDrive\Bureau\MAK - Cloud\CS - Cours\2A\S8\PP\app-reco-telecoop\xlsx_to_json\exec\database_on_id.json'
